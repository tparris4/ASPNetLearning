...
namespace RunGroupApplicatiom.Migrations
{
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Racess", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Racess_Addresses_AddressId",
                        column: x => x.AddressId,
                        principalTable: "Addresses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Racess_AppUser_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AppUser",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Racess_AddressId",
                table: "Racess",
                column: "AddressId");

            migrationBuilder.CreateIndex(
                name: "IX_Racess_AppUserId",
                table: "Racess",
                column: "AppUserId");
        }
